...
export async function handle({ event, resolve }) {
	...
	const anonRoutes = [ '/register', '/login', '/verify', '/verify/verified', '/change/delete', '/change/password', '/change/password/new', '/offline', '/banned', '/banned/register', '/install', '/install/app', '/' ];
