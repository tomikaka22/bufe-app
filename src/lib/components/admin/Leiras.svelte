<script>
	...
	export let data;
	export let leirasModal;

	let input;

</script>

<dialog class="bg-surface-variant rounded-2xl text-secondary" bind:this={leirasModal}>
	<AdminTopbar midText={'Leírás'} input={input} modal={leirasModal}></AdminTopbar>
		<div class="m-4 mt-2">
