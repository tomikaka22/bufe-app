...
{#if !hideNavbarRoutes.includes($page.url.pathname)}
	<div class:navbar-background-noconflict={!backgroundConflict.includes($page.url.pathname)} class="bg-foreground text-on-background flex gap-5 justify-between items-start fixed bottom-0 w-full text-sm h-[5.25rem] transition-all px-5 pt-3 z-10">
		...
		<a href="/list" class="flex flex-col h-16 w-1/4 transition-all" class:active-nav={termekekRoutes.includes($page.route.id)}>
		...
		<a href="/kosar" class="flex flex-col h-16 w-1/4 transition-all" class:active-nav={kosarRoutes.includes($page.route.id)}>
		...
		<a href="/profil" class="flex flex-col h-16 w-1/4 transition-all" class:active-nav={profilRoutes.includes($page.route.id)}>
