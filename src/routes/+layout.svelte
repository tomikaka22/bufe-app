...
{#if !hideNavbarRoutes.includes($page.url.pathname)}
	<div class:navbar-background-noconflict={!backgroundConflict.includes($page.url.pathname)} class="bg-foreground text-on-background flex justify-between items-start fixed bottom-0 w-full text-sm h-[5.25rem] transition-all px-5 pt-3 z-10">
		<a href="/" class="flex flex-col h-16 transition-all" class:active-nav={homeRoutes.includes($page.route.id)}>
			<div class="w-full h-1/2 flex justify-center items-center rounded-3xl py-1 px-5 transition-all" class:active-img={homeRoutes.includes($page.route.id)}>
		...
		<a href="/list" class="flex flex-col h-16 transition-all" class:active-nav={termekekRoutes.includes($page.route.id)}>
			<div class="w-full h-1/2 flex justify-center items-center rounded-3xl py-1 px-5 transition-all" class:active-img={termekekRoutes.includes($page.route.id)}>
		...
		<a href="/kosar" class="flex flex-col h-16 transition-all" class:active-nav={kosarRoutes.includes($page.route.id)}>
			<div class="w-full h-1/2 relative flex justify-center items-center rounded-3xl py-1 px-5 transition-all" class:active-img={kosarRoutes.includes($page.route.id)}>
		...
		<a href="/profil" class="flex flex-col h-16 transition-all" class:active-nav={profilRoutes.includes($page.route.id)}>
			<div class="w-full h-1/2 flex justify-center items-center rounded-3xl py-1 px-5 transition-all" class:active-img={profilRoutes.includes($page.route.id)}>
				<img class:profileActive={profilRoutes.includes($page.route.id)} class="h-full w-full rounded-lg transition-all grayscale-[0.5]" src="/api/avatar" alt="">
			</div>
