 ...
 <main in:fade={{ duration: 180 }}>
	...
	></Topbar>
	 ...
	 {/if}
		 ...
		 <div class="w-full fixed bottom-6 left-0 px-5 flex justify-center">
			 <button on:click={buy} style="box-shadow: 0px 0px 5px 2px #2b221d;" class="w-full shadow-background bg-primary-container text-on-secondary-container font-semibold transition-all py-2 mr-2 px-10 rounded-3xl text-lg hover:bg-primary hover:text-on-primary hover:rounded-lg">kosárba</button>
			 <form 
				 use:enhance 
			 ...
			 >
				 ...
				 <button style="box-shadow: 0px 0px 5px 2px #2b221d;" class="shadow-background bg-primary-container text-on-secondary-container font-semibold transition-all p-2 px-3 rounded-3xl text-lg hover:bg-primary hover:text-on-primary hover:rounded-lg"><i class="fa-solid fa-star"></i></button>
			 </form>
		 </div>
